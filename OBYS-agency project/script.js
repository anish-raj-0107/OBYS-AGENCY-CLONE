...
function loadingAnimation() {
  ...
  tl.from("#nikku1 h1, #nikku2 h1, #nikku3 h2, #nikku4 h1", {
    y: 140,
    stagger: 0.2,
  });
}
...
document.querySelector("#nikku3").addEventListener("mouseenter",
  function(){
    gsap.to("#flag",{
      opacity: 1,
    })
  })
  document.querySelector("#nikku3").addEventListener("mouseleave",
    function(){
      gsap.to("#flag",{
        opacity: 0,
      })
